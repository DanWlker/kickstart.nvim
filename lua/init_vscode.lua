...
map('n', '<leader>ff', function() require('vscode').action 'workbench.action.quickOpen' end)
map('n', '<leader>fg', function() require('vscode').action 'workbench.action.findInFiles' end)
map('n', '<leader>fc', function() require('vscode').action 'workbench.action.showCommands' end)
map('n', 'u', function() require('vscode').action 'undo' end)
map('n', '<c-r>', function() require('vscode').action 'redo' end)
map('n', '<c-w>d', function() require('vscode').action 'editor.action.showHover' end)
